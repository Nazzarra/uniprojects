...
public class ProgramHeaderEnumDecl extends ProgramHeaderDeclList {

    private ProgramHeaderDeclList ProgramHeaderDeclList;
    private EnumDecl EnumDecl;

    public ProgramHeaderEnumDecl (ProgramHeaderDeclList ProgramHeaderDeclList, EnumDecl EnumDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ProgramHeaderEnumDecl(\n");
