...
public class MethodVarDeclMultiple extends LocalVarDeclList {

    private LocalVarDeclList LocalVarDeclList;
    private VarDeclList VarDeclList;

    public MethodVarDeclMultiple (LocalVarDeclList LocalVarDeclList, VarDeclList VarDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodVarDeclMultiple(\n");
